...
EOS
    ...
    assert_equal 2, long_string.lines.count # lines in file
    assert_equal "I", long_string[0,1] # first character of first line
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # It changes percolates through the var assignments. Every
    # reference stays up to date despite changes
